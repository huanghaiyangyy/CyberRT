...
class Header PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kFusionTimestampFieldNumber = 10,
  };
  ...
  bool has_e2e_msg() const;
  private:
  bool _internal_has_e2e_msg() const;
  public:
  void clear_e2e_msg();
  const std::string& e2e_msg() const;
  void set_e2e_msg(const std::string& value);
  void set_e2e_msg(std::string&& value);
  void set_e2e_msg(const char* value);
  void set_e2e_msg(const void* value, size_t size);
  std::string* mutable_e2e_msg();
  std::string* release_e2e_msg();
  void set_allocated_e2e_msg(std::string* e2e_msg);
  private:
  const std::string& _internal_e2e_msg() const;
  void _internal_set_e2e_msg(const std::string& value);
  std::string* _internal_mutable_e2e_msg();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr e2e_msg_;
...
// optional uint64 fusion_timestamp = 10;
inline bool Header::_internal_has_fusion_timestamp() const {
  bool value = (_has_bits_[0] & 0x00000400u) != 0;
  return value;
}
inline bool Header::has_fusion_timestamp() const {
  return _internal_has_fusion_timestamp();
}
inline void Header::clear_fusion_timestamp() {
  fusion_timestamp_ = PROTOBUF_ULONGLONG(0);
  _has_bits_[0] &= ~0x00000400u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Header::_internal_fusion_timestamp() const {
  return fusion_timestamp_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Header::fusion_timestamp() const {
  // @@protoc_insertion_point(field_get:apollo.common.Header.fusion_timestamp)
  return _internal_fusion_timestamp();
}
inline void Header::_internal_set_fusion_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000400u;
  fusion_timestamp_ = value;
}
inline void Header::set_fusion_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_fusion_timestamp(value);
  // @@protoc_insertion_point(field_set:apollo.common.Header.fusion_timestamp)
}

// optional bytes e2e_msg = 11;
inline bool Header::_internal_has_e2e_msg() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool Header::has_e2e_msg() const {
  return _internal_has_e2e_msg();
}
inline void Header::clear_e2e_msg() {
  e2e_msg_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000004u;
}
inline const std::string& Header::e2e_msg() const {
  // @@protoc_insertion_point(field_get:apollo.common.Header.e2e_msg)
  return _internal_e2e_msg();
}
inline void Header::set_e2e_msg(const std::string& value) {
  _internal_set_e2e_msg(value);
  // @@protoc_insertion_point(field_set:apollo.common.Header.e2e_msg)
}
inline std::string* Header::mutable_e2e_msg() {
  // @@protoc_insertion_point(field_mutable:apollo.common.Header.e2e_msg)
  return _internal_mutable_e2e_msg();
}
inline const std::string& Header::_internal_e2e_msg() const {
  return e2e_msg_.Get();
}
inline void Header::_internal_set_e2e_msg(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  e2e_msg_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void Header::set_e2e_msg(std::string&& value) {
  _has_bits_[0] |= 0x00000004u;
  e2e_msg_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:apollo.common.Header.e2e_msg)
}
inline void Header::set_e2e_msg(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000004u;
  e2e_msg_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:apollo.common.Header.e2e_msg)
}
inline void Header::set_e2e_msg(const void* value,
    size_t size) {
  _has_bits_[0] |= 0x00000004u;
  e2e_msg_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:apollo.common.Header.e2e_msg)
}
inline std::string* Header::_internal_mutable_e2e_msg() {
  _has_bits_[0] |= 0x00000004u;
  return e2e_msg_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* Header::release_e2e_msg() {
  // @@protoc_insertion_point(field_release:apollo.common.Header.e2e_msg)
  if (!_internal_has_e2e_msg()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000004u;
  return e2e_msg_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Header::set_allocated_e2e_msg(std::string* e2e_msg) {
  if (e2e_msg != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  } else {
    _has_bits_[0] &= ~0x00000004u;
  }
  e2e_msg_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), e2e_msg,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:apollo.common.Header.e2e_msg)
}
