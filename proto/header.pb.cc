...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_header_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::common::Header, fusion_timestamp_),
  PROTOBUF_FIELD_OFFSET(::apollo::common::Header, e2e_msg_),
  4,
  0,
  7,
  5,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 16, sizeof(::apollo::common::Header)},
};
...
const char descriptor_table_protodef_header_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "lo.common.StatusPb\022\020\n\010frame_id\030\t \001(\t\022\030\n\020"
  "fusion_timestamp\030\n \001(\004\022\017\n\007e2e_msg\030\013 \001(\014"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_header_2eproto = {
  false, false, descriptor_table_protodef_header_2eproto, "header.proto", 319,
...
class Header::_Internal {
 public:
  ...
  static void set_has_fusion_timestamp(HasBits* has_bits) {
    (*has_bits)[0] |= 1024u;
  }
  static void set_has_e2e_msg(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
};
...
Header::Header(const Header& from)
  ...
  e2e_msg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_e2e_msg()) {
    e2e_msg_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_e2e_msg(), 
      GetArena());
  }
  ...
  ::memcpy(&timestamp_sec_, &from.timestamp_sec_,
    static_cast<size_t>(reinterpret_cast<char*>(&fusion_timestamp_) -
    reinterpret_cast<char*>(&timestamp_sec_)) + sizeof(fusion_timestamp_));
...
void Header::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      ...
      0, static_cast<size_t>(reinterpret_cast<char*>(&fusion_timestamp_) -
      reinterpret_cast<char*>(&status_)) + sizeof(fusion_timestamp_));
}
...
void Header::SharedDtor() {
  ...
  e2e_msg_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
// @@protoc_insertion_point(message_clear_start:apollo.common.Header)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      e2e_msg_.ClearNonDefaultToEmpty();
    }
  ...
  if (cached_has_bits & 0x00000700u) {
    ::memset(&version_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&fusion_timestamp_) -
        reinterpret_cast<char*>(&version_)) + sizeof(fusion_timestamp_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 80)) {
          _Internal::set_has_fusion_timestamp(&has_bits);
          fusion_timestamp_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 90)) {
          auto str = _internal_mutable_e2e_msg();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Header::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000400u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64ToArray(10, this->_internal_fusion_timestamp(), target);
  }

  // optional bytes e2e_msg = 11;
  if (cached_has_bits & 0x00000004u) {
    target = stream->WriteBytesMaybeAliased(
        11, this->_internal_e2e_msg(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:apollo.common.Header)
  ...
  if (cached_has_bits & 0x00000700u) {
    ...
    if (cached_has_bits & 0x00000400u) {
      total_size += 1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt64Size(
          this->_internal_fusion_timestamp());
    }
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.common.Header)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _internal_set_e2e_msg(from._internal_e2e_msg());
    }
    if (cached_has_bits & 0x00000008u) {
...
void Header::InternalSwap(Header* other) {
  ...
  e2e_msg_.Swap(&other->e2e_msg_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Header, fusion_timestamp_)
      + sizeof(Header::fusion_timestamp_)
